...
#the retrieve value of hex_list is a list of just member
print(hex_list)
jfile.close()
#the following is needed to convert a list of one element into a string 
mystring=''
for x in hex_list:
    mystring += ''+x
print(mystring)
#the following is needed to convert a string of characters separeted by ";" into a new list 
...
if vlid=='all':
    for id in range(len(list_vlans)):
        ...
        #print(i)
        #jfile.close()
        print("The interfaces untagged on vlan:",list_vlans[id],"are :",str(Result))
    #
else:
    id=int(idvlan)
    print(hex_vlans)
